...
enum Entrypoint {
    static func main() async throws {
        ...
        // You can enable it if you'd like to reduce the amount of context switching
        // between NIO and Swift Concurrency.
        //
        // Note: this has caused issues with some libraries that use `.wait()` and
        // cleanly shutting down. If enabled, you should be careful about calling async
        // functions before this point as it can cause assertion failures.
        //
